...
<head>
  ...
  <script>
    <?php
    include_once './Header/drop-down-profile.js';
    ?>
  </script>
  <title>Header</title>
</head>
    ...
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      ?>
        <div class="w3-dropdown">
          ...
          <img src="./Profile/<?= $profile['image'] ?>" alt="Profile Picture" onclick="myFunction()" width="50px" height="50px" style="border-radius: 7px;">
